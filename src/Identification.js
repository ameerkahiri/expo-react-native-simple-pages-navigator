    ...
    render(){
        return (
            ...
            <ScrollView style={styles.main_container}>
                ...
                <View>
                    <Text style={[{ margin:15, marginTop:20}]}>Review your details</Text>
                </View>

                <View style={[{borderWidth:2, borderColor:'#FF3F77',  marginHorizontal:15, flexDirection: 'row', borderRadius:10, marginBottom:35}]}>
